...
# ─────────────────────────────────────────────────────────────────────────────
# Bucket auto-provisioning — helper compartilhado em src/services/rag/__init__.py
# (mesmo flag RAG_AUTO_PROVISION serve para o corpus Athena — VEC-394).
# ─────────────────────────────────────────────────────────────────────────────
from src.services.rag import ensure_bucket_exists as _ensure_rag_bucket_exists  # noqa: E402
